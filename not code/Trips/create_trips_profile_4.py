...
people =  pd.read_csv('all_pers_type_4.csv')# TODO LOAD pers and filter tripChainType 1
print(people)
...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        distance, start_time_to_work_pos, start_time_to_work_hour, start_time_to_work_min, end_time_to_work_pos, end_time_to_work_hour, end_time_to_work_min, delta_t_to_work = trip_to_work(ss_loisir, ss_work, pers_worker_id, end_time_to_loisir_pos, 90)
