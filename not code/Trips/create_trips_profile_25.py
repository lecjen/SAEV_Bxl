...
people = pd.read_csv('all_pers_type_25.csv')# TODO LOAD pers and filter tripChainType 1
print(people)
...
for pers in people.index:
    ...
    ss_loisir_g, long_loisir_g, lat_loisir_g, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_home, -1, 0)
