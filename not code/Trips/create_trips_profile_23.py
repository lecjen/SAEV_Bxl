...
people = pd.read_csv('all_pers_type_23.csv')# TODO LOAD pers and filter tripChainType 1
print(people)
...
for pers in people.index:
    ...
    distance, start_time_to_home_pos, start_time_to_home_hour, start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour, end_time_to_home_min, delta_t_to_home = trip_to_home(ss_loisir_g, end_time_to_loisir_pos, 4*60)
