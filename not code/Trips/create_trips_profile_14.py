...
people = pd.read_csv('all_pers_type_14.csv')# TODO LOAD pers and filter tripChainType 1
print(people)
...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        ss_loisir, long_loisir, lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_work, end_time_to_work_pos, 8*60)
        ...
        distance, start_time_to_home_pos, start_time_to_home_hour, start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour, end_time_to_home_min, delta_t_to_home = trip_to_home(ss_loisir, end_time_to_loisir_pos, 2*60)
