...
people = pd.read_csv('all_pers_type_2.csv')# TODO LOAD pers and filter tripChainType 1
print(people)
...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        ss_loisir, long_loisir, lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_work, lat_work, long_work, end_time_to_work_pos)
...
print(trips)
trips.to_csv("Trips_profile_2.csv")