...
save_requests.to_csv('requests_test_2.csv')
"""
...
taxis = pd.DataFrame(columns = ["status", "nb_pers", "pos", "destination_book", "destination_working", "destination_time", "book_time", 
                                ...
                                "tot_pers_km", "pers_per_trip", "nb_trips", "km", "tot_charging_time", "book_charge_desination_time", "d_tmp", "status_time"])
l = []
        ...
        if min_t_request == t:
            ...
            for ori in origins:
                ...
                while len(filtered_requests) > 0:
                    ...
                    new_taxi = ["waiting", 1, ori, ori, r.destination, None, t, t, t + max_waiting_time, max_km_per_charge, None, 0, 0, 0, 0, 0, 0, 0, None, 0, l] #Taxi("waiting", ori)
...
print(taxis)
taxis.to_csv('taxis_simulation_3b.csv')
print(stations)
stations.to_csv('stations_simulation_3b.csv')      
end = time.now()
