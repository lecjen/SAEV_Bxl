...
for t in range(0, 424): #TODO check max departure time de mes trips
    print("t", t)
    ...
    if 4.286341286508197 in taxis.destination_book.tolist():
        stop
    
    taxis.to_csv('gans_simu_taxis_lim.csv')
    requests.to_csv('gans_simu_request_lim.csv')
    stations.to_csv('gans_simu_stations_lim.csv')
    cleaning_place.to_csv('gans_simu_cleaning_lim.csv')
