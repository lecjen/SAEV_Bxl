...
gans_cleaning_empty = pd.read_csv('gans_simu_cleaning_empty.csv') #0
gans_requests_empty = pd.read_csv('gans_simu_requests_empty.csv') 
gans_stations_empty = pd.read_csv('gans_simu_stations_empty.csv') #1 392
gans_taxis_empty = pd.read_csv('gans_simu_taxis_empty.csv') #1 532

gans_cleaning = pd.read_csv('gans_simu_cleaning.csv') #0
gans_requests = pd.read_csv('gans_simu_request.csv')
gans_stations = pd.read_csv('gans_simu_stations.csv') #1 733
gans_taxis = pd.read_csv('gans_simu_taxis.csv') #5 920
"""
