...
p = 0.37#% in bxl from bxl / in bxl from every where sup fr
...
print(jeune_parents)
jeune_parents.to_csv("18_20_jeune_parent_worker_workId_v2.csv")
...
print(en_retard_1)
en_retard_1.to_csv("jeune_sec_en_retard_1_workId_v2.csv")
...
print(en_retard_2)
en_retard_2.to_csv("jeune_sec_en_retard_2_workId_v2.csv")
...
for ind in unif_fr.index:
    ...
    if age >= age_min and age<= age_max:
        possible = jeune_student[(jeune_student.GenderID == sex) & (jeune_student.Age == age) &
                                 (jeune_student.Commune == unif_fr.loc[ind, "Commune_from"])]
...
for age in range(18, 21):
    ...
    for com in communes:
        ...
        if not nb_to_allocate_fe.empty:
            ...
            possible_fe = jeune_student[(jeune_student.GenderID == 1) & (jeune_student.Commune == com) & (jeune_student.Age == age)]
        ...
        if not nb_to_allocate_ho.empty:
            ...
            possible_ho = jeune_student[(jeune_student.GenderID == 0) & (jeune_student.Commune == com) & (jeune_student.Age == age)]
...
print(students)
students.to_csv("students_18_20_unif_workplace_v2.csv")
...
for age in range(18, 21):
    ...
    while nb_student_nl_age_fe > 0 and len(possible_fe)>0:
        ...
        if hh_id == 1 or hh_id == 2 or hh_id == 3 or hh_id == 4:
            ...
            students_nl.loc[i] = el[1:]

        elif hh_id == 5:
            el.extend(["4 or 5", "Unif on or off campus"])
            students_nl_off_or_on_campus_to_check.loc[i] = el[1:] #jeune_student.loc[ind_elu],"4 or 5", "Unif on or off campus"]
...
print(students_nl)
students_nl.to_csv("student_18_20_nl_workid_v2.csv")

print(students_nl_off_or_on_campus_to_check)
students_nl_off_or_on_campus_to_check.to_csv("student_18_20_nl_workid_4_or_5_to_check_v2.csv")
...
students_nl_out.to_csv("student_18_20_nl_to_out_workplace_v2.csv")
...
print(jeune_at_home)
jeune_at_home.to_csv("jeune_at_home_workId_v2.csv")

jeune_student["WorkID"]=6
jeune_student["WorkType"]="Worker"

print(jeune_student)
jeune_student.to_csv("jeune_wroker_workId_v2.csv")
...
jeune_collectif.to_csv("jeune_collectif_hopi_or_prison_v2.csv")
"""
i = 0
