...
#people = # TODO LOAD pers and filter tripChainType 1
...
def trip_to_work(ss_from, ss_work, pers_worker_id, end_time_to_previous_pos):
    ...
    while start_time_to_work_pos < end_time_to_previous_pos:
...
def trip_to_loisir(ss_from, end_time_to_previous_pos):
    ...
    while start_time_to_loisir_pos < end_time_to_previous_pos:
...
def trip_to_home(ss_from, end_time_to_previous_pos):
    ...
    while start_time_to_home_pos < end_time_to_previous_pos:
...
for pers in people.index:
    ...
    if ss_home != ss_work:
        #ADD trip 1 Home - Loisir
        ss_loisir, long_loisir, lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_home, -1)
        
        trips.loc[i]=[pers_id, 1, "H", "L", ss_home, long_home, lat_home, ss_loisir, long_loisir,
        ...
        #ADD trip 2 Loisir - Loisir General
        ss_loisir_g, long_loisir_g, lat_loisir_g, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_loisir, end_time_to_loisir_pos)
        
        trips.loc[i]=[pers_id, 2, "L", "LG", ss_loisir, long_loisir, lat_loisir, ss_loisir_g, long_loisir_g,
                      lat_loisir_g, distance, start_time_to_loisir_pos, start_time_to_loisir_hour,
                      start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour,
                      end_time_to_loisir_min, delta_t_to_loisir]
        i+=1
        print("i", i)
        
        #ADD trip 3 Loisir General - Loisir 2
        ss_loisir, long_loisir, lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_loisir_g, end_time_to_loisir_pos)
        
        trips.loc[i]=[pers_id, 3, "LG", "L", ss_loisir_g, long_loisir_g, lat_loisir_g, ss_loisir, long_loisir,
                      lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour,
                      start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour,
                      end_time_to_loisir_min, delta_t_to_loisir]
        i+=1
        ...
        #ADD trip 4 Loisir 2 - Home
        distance, start_time_to_home_pos, start_time_to_home_hour, start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour, end_time_to_home_min, delta_t_to_home = trip_to_home(ss_loisir, end_time_to_loisir_pos)
        
        trips.loc[i]=[pers_id, 4, "L", "H", ss_loisir, long_loisir, lat_loisir, ss_home, long_home,
        ...
        #ADD trip 5 Home - Loisir 2
        ss_loisir, long_loisir, lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_home, end_time_to_home_pos)
        
        trips.loc[i]=[pers_id, 5, "H", "L", ss_home, long_home, lat_home, ss_loisir, long_loisir,
                      lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour,
                      start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour,
                      end_time_to_loisir_min, delta_t_to_loisir]
        i+=1
        ...
        #ADD trip 6 Loisir - Home        
        distance, start_time_to_home_pos, start_time_to_home_hour, start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour, end_time_to_home_min, delta_t_to_home = trip_to_home(ss_loisir, end_time_to_loisir_pos)
        
        trips.loc[i]=[pers_id, 6, "L", "H", ss_loisir, long_loisir, lat_loisir, ss_home, long_home,
                      lat_home, distance, start_time_to_home_pos, start_time_to_home_hour,
                      start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour,
                      end_time_to_home_min, delta_t_to_home]
        i+=1
...
print(trips)
trips.to_csv("Trips_profile_31.csv")