...
for pers in people.index:
    ...
    if ss_home != ss_work:   
        ...
        trips.loc[i]=[pers_id, 1, "H", "LG", ss_home, long_home, lat_home, ss_loisir, long_loisir,
        ...
        #ADD trip 2 Loisir General - Home        
        ...
        trips.loc[i]=[pers_id, 2, "LG", "H", ss_loisir, long_loisir, lat_loisir, ss_home, long_home,
...
print(trips)
#trips.to_csv("Trips_profile_27.csv")