...
def trip_to_work(ss_from, ss_work, pers_worker_id):
...
def trip_to_loisir(ss_from, lat_from, long_from, end_time_to_previous_pos):
...
def trip_to_home(lat_from, long_from, end_time_to_previous_pos):
    distance = distance_two_points(ss_from, ss_home)
...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        #f
        distance, start_time_to_work_pos, start_time_to_work_hour, start_time_to_work_min, end_time_to_work_pos, end_time_to_work_hour, end_time_to_work_min, delta_t_to_work = trip_to_work(ss_home, ss_work, pers_worker_id)
...
print(trips)
trips.to_csv("Trips_profile_3.csv")