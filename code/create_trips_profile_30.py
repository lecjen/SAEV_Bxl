...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        trips.loc[i]=[pers_id, 2, "L", "H", ss_loisir, long_loisir, lat_loisir, ss_home, long_home,
        ...
        trips.loc[i]=[pers_id, 3, "H", "L", ss_home, long_home, lat_home, ss_loisir, long_loisir,
                      lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour,
                      start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour,
                      end_time_to_loisir_min, delta_t_to_loisir]
        i+=1
        ...
        #ADD trip 4 Loisir - Loisir General
        ...
        trips.loc[i]=[pers_id, 4, "L", "LG", ss_loisir, long_loisir, lat_loisir, ss_loisir_g, long_loisir_g,
        ...
        #ADD trip 5 Loisir General - Loisir 2
        ...
        trips.loc[i]=[pers_id, 5, "LG", "L", ss_loisir_g, long_loisir_g, lat_loisir_g, ss_loisir, long_loisir,
                      lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour,
                      start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour,
                      end_time_to_loisir_min, delta_t_to_loisir]
        i+=1
...
print(trips)
trips.to_csv("Trips_profile_30.csv")