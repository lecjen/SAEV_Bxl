...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        #ADD trip 3 Home - Loisir General
        ss_loisir_g, long_loisir_g, lat_loisir_g, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_home, end_time_to_home_pos)
        
        trips.loc[i]=[pers_id, 3, "H", "LG", ss_home, long_home, lat_home, ss_loisir_g, long_loisir_g,
        ...
        #ADD trip 4 Loisir General - Loisir
        ...
        trips.loc[i]=[pers_id, 4, "LG", "L", ss_loisir_g, long_loisir_g, lat_loisir_g, ss_loisir, long_loisir,
                      lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour,
                      start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour,
                      end_time_to_loisir_min, delta_t_to_loisir]
        i+=1
...
print(trips)
trips.to_csv("Trips_profile_28.csv")