...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        #f
        distance, start_time_to_work_pos, start_time_to_work_hour, start_time_to_work_min, end_time_to_work_pos, end_time_to_work_hour, end_time_to_work_min, delta_t_to_work = trip_to_work(ss_home, ss_work, pers_worker_id, -1)
        ...
        distance, start_time_to_home_pos, start_time_to_home_hour, start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour, end_time_to_home_min, delta_t_to_home = trip_to_home(ss_work, end_time_to_work_pos)
        
        trips.loc[i]=[pers_id, 2, "W", "H", ss_work, long_work, lat_work, ss_home, long_home,
        ...
        ss_loisir, long_loisir, lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_home, lat_home, long_home, end_time_to_home_pos)
        ...
        distance, start_time_to_home_pos, start_time_to_home_hour, start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour, end_time_to_home_min, delta_t_to_home = trip_to_home(lat_loisir, long_loisir, end_time_to_loisir_pos)
...
print(trips)
trips.to_csv("Trips_profile_12.csv")