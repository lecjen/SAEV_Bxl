...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        #ADD trip 2 Loisir - Work
        distance, start_time_to_work_pos, start_time_to_work_hour, start_time_to_work_min, end_time_to_work_pos, end_time_to_work_hour, end_time_to_work_min, delta_t_to_work = trip_to_work(ss_loisir, ss_work, pers_worker_id, end_time_to_loisir_pos)
        
        trips.loc[i]=[pers_id, 2, "L", "W", ss_loisir, long_loisir, lat_loisir, ss_work, long_work, lat_work, distance,
        ...
        #ADD trip 3 Work - Loisir
        ss_loisir, long_loisir, lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_work, end_time_to_work_pos)
        
        trips.loc[i]=[pers_id, 3, "W", "L", ss_work, long_work, lat_work, ss_loisir, long_loisir,
                      lat_loisir, distance, start_time_to_loisir_pos, start_time_to_loisir_hour,
                      start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour,
                      end_time_to_loisir_min, delta_t_to_loisir]
        i+=1
...
print(trips)
#trips.to_csv("Trips_profile_14.csv")