...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        #ADD trip 5 Loisir General - Home
        distance, start_time_to_home_pos, start_time_to_home_hour, start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour, end_time_to_home_min, delta_t_to_home = trip_to_home(ss_loisir_g, end_time_to_loisir_pos)
        
        trips.loc[i]=[pers_id, 5, "LG", "H", ss_loisir_g, long_loisir_g, lat_loisir_g, ss_home, long_home,
                      lat_home, distance, start_time_to_home_pos, start_time_to_home_hour,
                      start_time_to_home_min, end_time_to_home_pos, end_time_to_home_hour,
                      end_time_to_home_min, delta_t_to_home]
        i+=1
...
print(trips)
trips.to_csv("Trips_profile_23.csv")