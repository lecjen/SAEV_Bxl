...
for pers in people.index:
    ...
    if ss_home != ss_work:
        ...
        distance, start_time_to_work_pos, start_time_to_work_hour, start_time_to_work_min, end_time_to_work_pos, end_time_to_work_hour, end_time_to_work_min, delta_t_to_work = trip_to_work(ss_home, ss_work, ss_work, pers_worker_id, -1)
        ...
        #ADD trip 3 Home - Work
        distance, start_time_to_work_pos, start_time_to_work_hour, start_time_to_work_min, end_time_to_work_pos, end_time_to_work_hour, end_time_to_work_min, delta_t_to_work = trip_to_work(ss_home, ss_work, pers_worker_id, end_time_to_home_pos)
        
        trips.loc[i]=[pers_id, 3, "H", "W", ss_home, long_home, lat_home, ss_work, long_work, lat_work, distance,
                      start_time_to_work_pos, start_time_to_work_hour, start_time_to_work_min, 
                      end_time_to_work_pos, end_time_to_work_hour, end_time_to_work_min, delta_t_to_work]
        i+=1
...
print(trips)
#trips.to_csv("Trips_profile_15.csv")