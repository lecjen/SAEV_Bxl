...
for pers in people.index:
    ...
    if ss_home != ss_work:
        #ADD trip 1 Home - Loisir General
        ss_loisir_g, long_loisir_g, lat_loisir_g, distance, start_time_to_loisir_pos, start_time_to_loisir_hour, start_time_to_loisir_min, end_time_to_loisir_pos, end_time_to_loisir_hour, end_time_to_loisir_min, delta_t_to_loisir = trip_to_loisir(ss_home, -1)
        
        trips.loc[i]=[pers_id, 1, "H", "LG", ss_home, long_home, lat_home, ss_loisir_g, long_loisir_g,
        ...
        #ADD trip 2 Loisir General - Loisir
        ...
        trips.loc[i]=[pers_id, 2, "LG", "L", ss_loisir_g, long_loisir_g, lat_loisir_g, ss_loisir, long_loisir,
        ...
        trips.loc[i]=[pers_id, 3, "L", "H", ss_loisir, long_loisir, lat_loisir, ss_home, long_home,
...
print(trips)
trips.to_csv("Trips_profile_25.csv")